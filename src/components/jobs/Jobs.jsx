    ...
    return (
      <div className="education-container">
        ...
        <div className="tree-container education">
          <Role education={this.educationList[0]} />
          <Role education={this.educationList[1]} />
          <Role education={this.educationList[2]} />
        </div>
        <h1 className="interest-title">intrests</h1>
        <div className="hobbies-wrapper">
          <div className="box-hobbies development">
            <i class="img-fas far fa-file-code"></i>
          ...
          <div className="box-hobbies design">
            <i class="img-fas fas fa-pencil-ruler"></i>
          ...
          <div className="box-hobbies sport">
            <i class="img-fas fas fa-dumbbell"></i>
          ...
          <div className="box-hobbies backpack">
            <i class="img-fas fas fa-hiking"></i>
